      ...
      <div className="container-xxl d-flex align-items-center justify-content-between py-2">
        ...
        <div className="d-flex align-items-center">
          <Link to="/" className="text-decoration-none d-flex align-items-center">
            <span className="app-brand-logo me-3">
              <svg
                width="32"
                height="32"
                viewBox="0 0 25 42"
                         ...
                         <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                           <g id="Icon" transform="translate(27.000000, 15.000000)">
                             <g id="Mask" transform="translate(0.000000, 8.000000)">
                               ...
                               <use fill="#20b2aa" xlinkHref="#path-1" />
                               <g id="Path-3" mask="url(#mask-2)">
                                 <use fill="#20b2aa" xlinkHref="#path-3" />
                                 <use fillOpacity="0.2" fill="#FFFFFF" xlinkHref="#path-3" />
                               </g>
                               <g id="Path-4" mask="url(#mask-2)">
                                 <use fill="#20b2aa" xlinkHref="#path-4" />
                             ...
                             >
                               <use fill="#20b2aa" xlinkHref="#path-5" />
            ...
            <span className="h4 mb-0 text-primary fw-bolder">Flow Management Console</span>
          </Link>
        </div>

        {/* Global Search - Center */}
        <div className="d-flex align-items-center flex-grow-1 justify-content-center mx-3">
          <div className="input-group" style={{ maxWidth: '450px', minWidth: '350px' }}>
            ...
            <input
              ...
              style={{ fontSize: '15px', padding: '8px 12px', height: '38px' }}
            />
          </div>
        </div>
